...
- Build a minimal private admin panel for DEV testing and authenticated PROD operation over shared application services, independently of Slack credentials.
...
- `admin-panel`: Private administration UI with individual production sign-in, scoped roles, the full approved catalog and isolated DEV mocks.
